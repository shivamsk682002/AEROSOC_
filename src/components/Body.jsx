    ...
    <div id="container" className=" text-white text-lg bg-white bg-[url('./images/Space.jpg')] bg-cover bg-center  w-full " >
       ...
       <div id='about' className=' bg-sky-600  w-full text-white text-lg '>
         ...
         <div className=' text-5xl flex justify-center md:text-[10vh] h-[75px] padding  font-semibold items-center md:pt-[110px] '>
           ...
           <div className='text-sky-400  underline'> Events</div>
         ...
         <div  id='snapshots' className=' bg-sky-600  w-full text-white text-lg ' >
         <div className=' text-5xl flex justify-center md:text-[10vh] h-[75px] padding  font-semibold items-center md:pt-[50px] '>
           
           <div className=' text-slate-900  underline'> Snapshots</div>
           
           </div>
           <div id='contents' className='flex-row flex justify-center items-center  md:min-h-[calc(100vh-100px)]  pt-8 md:pt-0'>
             <Snapshots className=''/>
             </div>
         ...
         <div id='contact' className='bg-white bg-gradient-to-r  from-slate-900 to-slate-800 ... rounded-3xl w-[99%] m-auto '>
         <div className=' text-2xl m flex justify-center md:text-[8vh] h-[70px] padding  font-semibold items-center md:pt-[50px] '>
           
           <div className='  text-sky-400  pt-3 md:pt-0 md:underline flex justify-center text-center md:hidden'>
             <p></p>Connect with us for
             <br  /> Collaborations/Donations!</div>
             <div className='  text-sky-400  pt-3 md:pt-0 md:underline flex justify-center text-center hidden md:block'>
             <p></p>Connect with us for
